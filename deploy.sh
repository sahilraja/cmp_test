...
cp utils/roles.json utils/capabilities.json utils/rbac.json utils/country_codes.json utils/email_template.json utils/sms_template.json utils/system_config.json $builddir/utils
